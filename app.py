...
AUDIO_PATH = r"F:\MySnakeGame\assets\Audio\8-bit-heaven-starting-audio.mp3"
...
def create_start_menu():
    ...
    # Use jacquard_font_large for the header label.
    ...
    # Use jacquard_font_medium for radio buttons.
    difficulty_var = tk.StringVar(value="15")
    difficulties = {"Easy": "15", "Fast": "25", "Fastest": "35"}
    ...
    # Use jacquard_font_medium for the start button.
...
def start_game(chosen_difficulty):
    """Destroys the start menu and starts the game with the chosen difficulty."""
